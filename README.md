# Chaabane Portfolio (React + Vite)

A creative, SEO-friendly personal portfolio for **Chaabane Boussadia**, focused on software architecture and engineering impact.
...
- Uses CV and provided images from `public/`
